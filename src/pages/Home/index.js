...
const Page = () => {
  ...
  return <>
    ...
    <main>
      ...
      <section className="EventsContainer" data-testid="events-list" id="nos-realisations">
        <h2 className="Title">Nos réalisations</h2>
        <EventList />
      </section>
      <section className="PeoplesContainer" data-testid="people-list" id="notre-equipe">
